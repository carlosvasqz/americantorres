...
<html>
  <head>
    ...
    <title>Consultar Cierre Mensual | American Torres</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Consultar Cierre Mensual</h1>
            <p>Consultar el cierre de caja de un mes específico</p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Finanzas</li>
              <li>Consultas</li>
              <li><a href="#"> Consultar Cierre Mensual</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
