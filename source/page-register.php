  ...
  <section class="login-content">
    ...
    <div class="login-box">
      <form class="login-form" action="index.php">
        <h4 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>REGISTRARSE</h4>
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="password" id="password" name="password" placeholder=" Repita la Contraseña">
        </div>
        <div class="form-group btn-container">
          <button class="btn btn-primary btn-block" id="acceder"><i class="fa fa-sign-in fa-lg fa-fw"></i>REGISTRARSE</button>
        </div>
        <br />
