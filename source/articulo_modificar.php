<?php
   session_start();
    if (isset($_SESSION['username'])&&($_SESSION['type'])) { 
        ...
        $queryVerificar = mysqli_query($db, "SELECT COUNT(*) as Existe FROM articulos WHERE Id_Articulo='$codigo_buscar'") or die(mysqli_error());
        ...
        if ($rowExiste['Existe']!=0) {
            ...
            $queryVerificarTipoYCodigoRepetido = mysqli_query($db, "SELECT COUNT(*) as Existe FROM articulos WHERE Id_Articulo='$codigo_buscar'") or die(mysqli_error());
            ...
            if ($rowExisteTipoYCodigo['Existe']!=0) {
                ...
                $queryGuardar = mysqli_query($db, "UPDATE articulos SET Descripcion='$descripcion_articulo', Precio='$precio_articulo', Cantidad='$cantidad_articulo', Id_Contenedor='$contenedor_articulo', Id_Categoria='$categoria_articulo',  Disponible='$activo_disponible', Estado='$estado' WHERE Id_Articulo='$codigo_buscar'") or die(mysqli_error());
