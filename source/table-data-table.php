    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><a class="btn btn-primary btn-flat" href="#"><i class="fas fa-lg fa-plus"></i></a><a class="btn btn-info btn-flat" href="#"><i class="fas fa-lg fa-refresh"></i></a><a class="btn btn-warning btn-flat" href="#"><i class="fas fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
