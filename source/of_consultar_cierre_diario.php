...
<html>
  <head>
    ...
    <title>Consultar Cierre Diario | American Torres</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Consultar Cierre Diario</h1>
            <p>Consultar el cierre de caja de un día específico</p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Finanzas</li>
              <li>Consultas</li>
              <li><a href="#"> Consultar Cierre Diario</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
