          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a class="btn btn-primary icon-btn" href="https://select2.github.io/examples.php" target="_blank"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a class="btn btn-primary icon-btn" href="http://bootstrap-datepicker.readthedocs.org/en/stable/options.php" target="_blank"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
