...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="images/us.png" />     <title>Registrar Categoria | American Torres</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-plus-square"></i> Registrar categoria</h1>
              ...
              <div class="card-body">
                <form class="form-horizontal" id="guardar_cargo">
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="codigo_categoria" id="codigo_categoria" placeholder="Ingresar codigo de categoria">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-md-3">Nombre de categoria</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="nombre_categoria" id="nombre_categoria" placeholder="Ingresar nombre de categoria">
                    </div>
                  </div>
               ...
               <div class="form-group">
                    <label class="control-label col-md-3">Descripcion de categoria</label>
                    <div class="col-md-8">
