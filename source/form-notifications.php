    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fas fa-bell-o"></i> Form Notifications</h1>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a class="btn btn-primary icon-btn" href="http://bootstrap-notify.remabledesigns.com/" target="_blank"><i class="fas fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a class="btn btn-primary icon-btn" href="http://t4t5.github.io/sweetalert/" target="_blank"><i class="fas fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
