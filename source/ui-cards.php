    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fas fa-laptop"></i> Cards</h1>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a class="btn btn-primary icon-btn" href=""><i class="fas fa-plus"></i>Add Item	</a></p>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                <h3 class="title">All Items</h3>
                <div class="btn-group"><a class="btn btn-primary" href="#"><i class="fas fa-lg fa-plus"></i></a><a class="btn btn-info" href="#"><i class="fas fa-lg fa-edit"></i></a><a class="btn btn-warning" href="#"><i class="fas fa-lg fa-trash"></i></a></div>
              </div>
              <div class="card-body">
