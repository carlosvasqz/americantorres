    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div class="div">
            <h1><i class="fas fa-laptop"></i> Bootstrap Elements</h1>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="bs-element-section">
                ...
                <div class="row">
                  <div class="col-lg-7">
                    <p class="bs-component"><a class="btn btn-default" href="#">Default</a>&nbsp;<a class="btn btn-primary" href="#">Primary</a>&nbsp;<a class="btn btn-success" href="#">Success</a>&nbsp;<a class="btn btn-info" href="#">Info</a>&nbsp;<a class="btn btn-warning" href="#">Warning</a>&nbsp;<a class="btn btn-danger" href="#">Danger</a></p>
                    <p class="bs-component"><a class="btn btn-default disabled" href="#">Default</a>&nbsp;<a class="btn btn-primary disabled" href="#">Primary</a>&nbsp;<a class="btn btn-success disabled" href="#">Success</a>&nbsp;<a class="btn btn-info disabled" href="#">Info</a>&nbsp;<a class="btn btn-warning disabled" href="#">Warning</a>&nbsp;<a class="btn btn-danger disabled" href="#">Danger</a></p>
                    <div style="margin-bottom: 15px;">
                      <div class="btn-toolbar bs-component" style="margin: 0;">
                        <div class="btn-group"><a class="btn btn-default dropdown-toggle" href="#" data-toggle="dropdown">Default<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                        ...
                        <div class="btn-group"><a class="btn btn-primary dropdown-toggle" href="#" data-toggle="dropdown">Primary<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li><a href="#">Action</a></li>
                            <li><a href="#">Another action</a></li>
                            <li><a href="#">Something else here</a></li>
                        ...
                        <div class="btn-group"><a class="btn btn-success dropdown-toggle" href="#" data-toggle="dropdown">Success<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li><a href="#">Action</a></li>
                            <li><a href="#">Another action</a></li>
                            <li><a href="#">Something else here</a></li>
                        ...
                        <div class="btn-group"><a class="btn btn-warning dropdown-toggle" href="#" data-toggle="dropdown">Warning<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li><a href="#">Action</a></li>
                            <li><a href="#">Another action</a></li>
                            <li><a href="#">Something else here</a></li>
                        ...
                        <div class="btn-group"><a class="btn btn-danger dropdown-toggle" href="#" data-toggle="dropdown">Danger<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li><a href="#">Action</a></li>
                            <li><a href="#">Another action</a></li>
                            <li><a href="#">Something else here</a></li>
                    ...
                    <p class="bs-component"><a class="btn btn-primary btn-lg" href="#">Large button</a>&nbsp;<a class="btn btn-primary" href="#">Default button</a>&nbsp;<a class="btn btn-primary btn-sm" href="#">Small button</a>&nbsp;<a class="btn btn-primary btn-xs" href="#">Mini button</a>&nbsp;</p>
                  </div>
                  <div class="col-lg-5">
                    <p class="bs-component"><a class="btn btn-default btn-lg btn-block" href="#">Block level button</a></p>
                    ...
                    <div class="bs-component" style="margin-bottom: 15px;">
                      <div class="btn-toolbar">
                        ...
                        <div class="btn-group"><a class="btn btn-default" href="#">5</a>
                          <div class="btn-group"><a class="btn btn-default dropdown-toggle" href="#" data-toggle="dropdown">Dropdown<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                  ...
                  <div class="col-lg-4">
                    <div class="bs-component">
                      <div class="list-group"><a class="list-group-item" href="#">
                          ...
                          <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p></a><a class="list-group-item" href="#">
                          <h4 class="list-group-item-heading">List group item heading</h4>
