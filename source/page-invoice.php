    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title hidden-print">
          <div>
            <h1><i class="fas fa-file-text-o"></i> Invoice</h1>
          ...
          <div class="col-md-12">
            <div class="card">
              <section class="invoice">
                <div class="row">
                  <div class="col-xs-12">
                    <h2 class="page-header"><i class="fas fa-globe"></i> American Torres<small class="pull-right">Date: 01/01/2016</small></h2>
                  </div>
                </div>
                ...
                <div class="row hidden-print mt-20">
                  <div class="col-xs-12 text-right"><a class="btn btn-primary" href="javascript:window.print();" target="_blank"><i class="fas fa-print"></i> Print</a></div>
                </div>
              </section>
            </div>
          </div>
