    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fas fa-edit"></i> Form Samples</h1>
            <p>Sample forms</p>
          </div>
          <div>
            <ul class="breadcrumb">
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-footer">
                <button class="btn btn-primary icon-btn" type="button"><i class="fas fa-fw fa-lg fa-check-circle"></i>Register</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn" href="#"><i class="fas fa-fw fa-lg fa-times-circle"></i>Cancel</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="card">
              ...
              <div class="card-body3">
                <form class="form-inline">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary icon-btn" type="button"><i class="fas fa-fw fa-lg fa-check-circle"></i>Subscribe</button>
                  </div>
                </form>
              </div>
            </div>
