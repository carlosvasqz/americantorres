...
<html>
  ...
  <body class="sidebar-mini fixed">
     ...
     <header class="main-header hidden-print"><a class="logo" href="index.php">American Torres</a>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-plus-square"></i> Consultar categoria</h1>
          ...
          <div>
            <ul class="breadcrumb">
              ...
              <li>Categorias</li>
              <li><a href="#"> Cosultar Informaci&oacute;n de Categoria</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
         ...
         <div class="row">
            <div class="card">
              <div class="row">
                <div class="card-title">
                  <h4 class="card-title" align="center">Categoria(s) encontradas</h4>
                </div>
              </div>
              <div class="row">
    ...
    <script src="js/tips/consultar_categoria.js"></script>
