...
<html>
  <head>
    ...
    <title>Historial de Inversiones | American Torres</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Historial de Inversiones</h1>
            <p>Ver el historial de inversiones realizadas</p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Finanzas</li>
              <li>Historiales</li>
              <li><a href="#"> Historial de Inversiones</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
