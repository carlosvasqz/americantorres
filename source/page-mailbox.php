    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fas fa-envelope-o"></i> Mailbox</h1>
          </div>
          <div>
            <ul class="breadcrumb">
            ...
            <div class="card p-0">
              ...
              <div class="card-body">
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li class="active"><a href="#"><i class="fas fa-inbox fa-fw"></i> Inbox<span class="label label-primary pull-right">12</span></a></li>
                  <li><a href="#"><i class="fas fa-envelope-o fa-fw"></i> Sent</a></li>
                  <li><a href="#"><i class="fas fa-file-text-o fa-fw"></i> Drafts</a></li>
                  <li><a href="#"><i class="fas fa-filter fa-fw"></i> Junk <span class="label label-warning pull-right">65</span></a></li>
                  <li><a href="#"><i class="fas fa-trash-o fa-fw"></i> Trash</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-9">
            <div class="card">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-trash-o"></i></button>
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-reply"></i></button>
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-share"></i></button>
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-refresh"></i></button>
                </div>
              </div>
                ...
                <table class="table table-hover">
                  <tbody>
                    <tr>
                      ...
                      <td><a href="#"><i class="fas fa-star-o"></i></a></td>
              ...
              <div class="text-right semibold-text"><span class="text-muted mr-10">Showing 1-15 out of 60</span>
                <div class="btn-group">
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-chevron-left"></i></button>
                  <button class="btn btn-primary btn-sm" type="button"><i class="fas fa-chevron-right"></i></button>
                </div>
              </div>
            </div>
          </div>
