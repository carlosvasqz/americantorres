    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fas fa-archive"></i> Widgets</h1>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="widget-small primary"><i class="icon fas fa-users fa-3x"></i>
              <div class="info">
                <h4>Users</h4>
                <p><b>5</b></p>
              </div>
          ...
          <div class="col-md-3">
            <div class="widget-small info"><i class="icon fas fa-thumbs-o-up fa-3x"></i>
              <div class="info">
                <h4>Likes</h4>
                <p><b>25</b></p>
              </div>
          ...
          <div class="col-md-3">
            <div class="widget-small warning"><i class="icon fas fa-files-o fa-3x"></i>
              <div class="info">
                <h4>Uploades</h4>
                <p><b>10</b></p>
              </div>
          ...
          <div class="col-md-3">
            <div class="widget-small danger"><i class="icon fas fa-star fa-3x"></i>
              <div class="info">
                <h4>Stars</h4>
                <p><b>500</b></p>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="widget-small info coloured-icon"><i class="icon fas fa-thumbs-o-up fa-3x"></i>
              <div class="info">
                <h4>Likes</h4>
                <p><b>25</b></p>
              </div>
          ...
          <div class="col-md-3">
            <div class="widget-small warning coloured-icon"><i class="icon fas fa-files-o fa-3x"></i>
              <div class="info">
                <h4>Uploades</h4>
                <p><b>10</b></p>
              </div>
            ...
            <div class="card">
              ...
              <div class="messanger">
                ...
                <div class="sender">
                  ...
                  <button class="btn btn-primary" type="button"><i class="fas fa-lg fa-fw fa-paper-plane"></i></button>
                </div>
              </div>
            </div>
          </div>
